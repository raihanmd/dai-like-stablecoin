...
} from "~/lib/scaffold-eth/contract";
import { useSelectedNetwork } from "./useSelectedNetwork";
import { useDeployedContractInfo } from "./useDeployedContractInfo";
import type { AllowedChainIds } from "~/lib/scaffold-eth";
import { replacer } from "~/lib/scaffold-eth/common";
...
/**
 * @deprecated **Recommended only for local (anvil/anvil) chains and development.**
...
>) => {
  ...
  useEffect(() => {
    if (selectedNetwork.id !== anvil.id) {
      console.log(
